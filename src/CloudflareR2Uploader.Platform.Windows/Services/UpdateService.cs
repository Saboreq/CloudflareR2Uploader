...
namespace CloudflareR2Uploader.Services
{
    public sealed class UpdateService : IDisposable
    {
        ...
        /// <summary>
        /// The running application's version, used for the update User-Agent when no value
        /// is supplied. Read from the entry assembly so this service does not depend on any
        ...
        /// <summary>
        /// A User-Agent product version may not contain whitespace or separators, and a
        /// build metadata suffix such as "+abc123" is not useful to the server.
        /// </summary>
