...
namespace CloudflareR2Uploader.Utilities
{
    ...
    public static class AppPaths
    {
        ...
        /// <summary>
        /// Sanitised, user-visible operation history shown on the Activity screen. One JSON
        /// object per line. Contains no credentials and no signed URLs.
        /// </summary>
        public static string ActivityHistoryFilePath { get { return Path.Combine(Root, "activity.jsonl"); } }
