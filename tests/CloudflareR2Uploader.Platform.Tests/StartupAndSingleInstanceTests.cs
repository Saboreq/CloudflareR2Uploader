...
namespace CloudflareR2Uploader.Tests
{
    ...
    {
        private static readonly string[] BackgroundArguments = { "--unknown", "--background" };
        private static readonly string[] UnknownArguments = { "--unknown" };
        ...
        [TestMethod] public void SingleInstanceHelpers_AreStableSafeAndIgnoreUnknownArguments()
        {
            ...
            Assert.AreEqual(InstanceLaunchCommand.Background, SingleInstanceCoordinator.ParseArguments(BackgroundArguments));
            Assert.AreEqual(InstanceLaunchCommand.Show, SingleInstanceCoordinator.ParseArguments(UnknownArguments));
        }
